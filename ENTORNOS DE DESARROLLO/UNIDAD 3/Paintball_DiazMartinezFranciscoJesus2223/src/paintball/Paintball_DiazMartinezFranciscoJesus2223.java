...
public class Paintball_DiazMartinezFranciscoJesus2223 {
     int municionMaxima;
     int municionCargada;
 
    
    /* Constructor sin argumentos */
    public Paintball_DiazMartinezFranciscoJesus2223 () {}
    
// Constructor con parámetro para iniciar todas las propiedades de la clase Paintball
    public Paintball_DiazMartinezFranciscoJesus2223(int munMax, int munCarg){
